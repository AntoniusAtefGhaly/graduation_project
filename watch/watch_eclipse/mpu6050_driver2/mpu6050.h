...
float avgAcc;    //to compare value of acc with it;
int steps_numberX,flag_stepX, step_thresholdX ;

int steps_numberY,flag_stepY, step_thresholdY ;

int steps_numberZ,flag_stepZ, step_thresholdZ ;

int steps_number ;


/*************  global variables for step counter function **********/
int flag_fallen ,fallen_threshold;
...
void step_counterX(void);

void step_counterY(void);

void step_counterZ(void);
